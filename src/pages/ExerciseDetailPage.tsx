...
/*
 * useParams reads the :id segment from the current URL. The component does
 * not receive the exercise as a prop — the URL is the input. This is why
 * routing eliminates prop drilling for navigation state: the URL replaces
 * the selectedExercise prop that App previously threaded down the tree.
 *
